      ...
      <div className="glass mx-4 mt-4 px-6 py-4 rounded-2xl">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6">
            ...
            <Link
              to="/predict"
              className={`text-sm font-medium transition-colors duration-200 ${location.pathname === "/predict"
                ? "text-primary"
                : "text-muted-foreground hover:text-foreground"
                }`}
            >
            ...
            <Link
              to="/compare"
              className={`text-sm font-medium transition-colors duration-200 ${location.pathname === "/compare"
                ? "text-primary"
                : "text-muted-foreground hover:text-foreground"
                }`}
            >
